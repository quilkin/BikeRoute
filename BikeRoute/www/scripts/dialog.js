...
var MAPMODULE = (function ($,myMap) {
    myMap.optionsDialog() = function (){
        if (MAPMODULE.wayPoints.length > 2) {
        ...
        var contents =
               '<div class="row">  ' +
                ...
                '<input type="radio" name="bike" id="bike-0" value="Mountain"' + ((myMap.bikeType === 'Mountain') ? 'checked="checked"' : '') + '"> Mountain </label> ' +
                '</div><div class="radio"> <label for="bike-1"> ' +
                '<input type="radio" name="bike" id="bike-1" value="Cross" ' + ((myMap.bikeType === 'Cross') ? 'checked="checked"' : '') + '"> Cross </label> ' +
                '</div><div class="radio"> <label for="bike-2"> ' +
                '<input type="radio" name="bike" id="bike-2" value="Hybrid"' + ((myMap.bikeType === 'Hybrid') ? 'checked="checked"' : '') + '"> Hybrid/Town </label> ' +
                '</div><div class="radio"> <label for="bike-3"> ' +
                '<input type="radio" name="bike" id="bike-3" value="Road" ' + ((myMap.bikeType === 'Road') ? 'checked="checked"' : '') + '"> Road </label> ' +
                '</div> ' +
                '</div> </div>' +
                '<div class="form-group"> ' +
                ...
                '<input type="radio" name="hills" id="hills-0" value="0"' + ((myMap.useHills < 3) ? 'checked="checked"' : '') + '"> Little as possible </label> ' +
                '</div><div class="radio"> <label for="hills-1"> ' +
                '<input type="radio" name="hills" id="hills-1" value="5" ' + ((myMap.useHills >= 3 && myMap.useHills <= 7) ? 'checked="checked"' : '') + '"> A few </label> ' +
                '</div><div class="radio"> <label for="hills-2"> ' +
                '<input type="radio" name="hills" id="hills-2" value="9"' + ((myMap.useHills > 7) ? 'checked="checked"' : '') + '"> Lots </label> ' +
                '</div> ' +
                '</div> </div>' +
                '<div class="form-group"> ' +
                ...
                '<input type="radio" name="roads" id="roads-0" value="0"' + ((myMap.useroads < 3) ? 'checked="checked"' : '') + '"> Little as possible </label> ' +
                '</div><div class="radio"> <label for="roads-1"> ' +
                '<input type="radio" name="roads" id="roads-1" value="5" ' + ((myMap.useroads >= 3 && myMap.useroads <= 7) ? 'checked="checked"' : '') + '"> A few </label> ' +
                '</div><div class="radio"> <label for="roads-2"> ' +
                '<input type="radio" name="roads" id="roads-2" value="9"' + ((myMap.useroads > 7) ? 'checked="checked"' : '') + '"> More </label> ' +
                '</div> ' +
                '</div> </div>' +
                '</form> </div>  </div>';
        bootbox.dialog({
            ...
            buttons: {
                success: {
                    ...
                    callback: function () {
                        myMap.bikeType = $("input[name='bike']:checked").val();
                        myMap.useHills = $("input[name='hills']:checked").val();
                        myMap.useRoads = $("input[name='roads']:checked").val();
                        if (myMap.wayPoints.length === 2)
                            createRoute();
...
//        var closeIcon = L.DomUtil.create('i', '&cross;');
